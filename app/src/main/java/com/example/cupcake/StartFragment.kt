...
/**
 * Ini adalah tampilan layar pertama dari aplikasi Cupcake. Pengguna dapat memilih berapa banyak cupcakes yang akan dipesan.
 * adalah layar pertama yang ditampilkan di aplikasi. Layar ini memiliki gambar cupcake dan tiga tombol untuk memilih jumlah cupcake untuk dipesan: satu cupcake, enam cupcake, dan dua belas cupcake.
 */
class StartFragment : Fragment() {

// adalah layar pertama yang ditampilkan di aplikasi. Class ini berisi kode view binding dan pemroses klik untuk ketiga tombol.
