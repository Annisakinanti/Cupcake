...
/**
 * [FlavorFragment] memungkinkan pengguna untuk memilih rasa cupcake untuk yang akan dipesan nantinya.
 * menampilkan daftar rasa cupcake sebagai opsi tombol pilihan dengan tombol Next.
 */
class FlavorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.apply {
            ...
            // meneetapkan model tampilan ke properti di kelas pengikatan
    ...
    /**
     * mengarahkan ke layar berikutnya untuk memilih tanggal pengambilan.
     */
    fun goToNextScreen() {
